...
print(" ")
print("ros2-gst-360-detect-car-test")
print(" ")
...
img_publishers = {
    ...
    'q3': node_image.create_publisher(Image, 'camera/image/q3', 10),
    'q4': node_image.create_publisher(Image, 'camera/image/q4', 10)
}
bridge = CvBridge()
...
try:
    while True:
        ...
        quadrants = {
            'q1': frame_shifted[360:840, :width // 4],                  #front
            'q2': frame_shifted[360:840, width // 4:width // 2],        #right
            'q3': frame_shifted[360:840, width // 2:3 * width // 4],    #back
            'q4': frame_shifted[360:840, 3 * width // 4:]               #left
        }
