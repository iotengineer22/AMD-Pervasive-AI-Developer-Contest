...
#
# kr260-gpio-test.tcl: Tcl script for re-creating project 'kr260-gpio-test'
#
# Generated by Vivado on Tue May 28 07:48:32 JST 2024
...
#
# 1. This project restoration tcl script (kr260-gpio-test.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/iotengineer/kr260-gpio-test/kr260-gpio-test.srcs/constrs_1/new/gpio-test.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/kr260-gpio-test.srcs/constrs_1/new/gpio-test.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "kr260-gpio-test"
...
set script_file "kr260-gpio-test.tcl"
...
set file "[file normalize "$origin_dir/kr260-gpio-test.srcs/constrs_1/new/gpio-test.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/gpio-test.xdc"
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/kr260-gpio-test.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
