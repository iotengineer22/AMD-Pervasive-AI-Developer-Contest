...
#
# kr260-pwm-test.tcl: Tcl script for re-creating project 'kr260-pwm-test'
#
# Generated by Vivado on Tue May 28 19:09:36 JST 2024
...
#
# 1. This project restoration tcl script (kr260-pwm-test.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/iotengineer/kr260-pwm-test/kr260-pwm-test.srcs/constrs_1/new/pwm-test.xdc"
#    "/home/iotengineer/kr260-pwm-test/kr260-pwm-test.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/kr260-pwm-test.srcs/constrs_1/new/pwm-test.xdc"]"\
 "[file normalize "$origin_dir/kr260-pwm-test.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "kr260-pwm-test"
...
set script_file "kr260-pwm-test.tcl"
...
set file "[file normalize "$origin_dir/kr260-pwm-test.srcs/constrs_1/new/pwm-test.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/pwm-test.xdc"
...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins ps8_0_axi_periph/M02_AXI] [get_bd_intf_pins axi_timer_1/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_timer_2/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins axi_timer_3/S_AXI]
  ...
  connect_bd_net -net axi_timer_0_pwm0 [get_bd_pins axi_timer_0/pwm0] [get_bd_ports pwm_0]
  connect_bd_net -net axi_timer_1_pwm0 [get_bd_pins axi_timer_1/pwm0] [get_bd_ports pwm_1]
  connect_bd_net -net axi_timer_2_pwm0 [get_bd_pins axi_timer_2/pwm0] [get_bd_ports pwm_2]
  connect_bd_net -net axi_timer_3_pwm0 [get_bd_pins axi_timer_3/pwm0] [get_bd_ports pwm_3]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins axi_timer_2/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins axi_timer_3/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M04_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins axi_timer_2/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins axi_timer_3/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M04_ACLK]
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timer_1/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timer_2/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timer_3/S_AXI/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.52201",
   "Default View_TopLeft":"-238,-115",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port gpio_rtl_0 -pg 1 -lvl 4 -x 1290 -y 480 -defaultsOSRD
preplace port port-id_pwm_0 -pg 1 -lvl 4 -x 1290 -y 120 -defaultsOSRD
preplace port port-id_pwm_1 -pg 1 -lvl 4 -x 1290 -y 320 -defaultsOSRD
preplace port port-id_pwm_2 -pg 1 -lvl 4 -x 1290 -y 660 -defaultsOSRD
preplace port port-id_pwm_3 -pg 1 -lvl 4 -x 1290 -y 860 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 340 -y 370 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 1140 -y 480 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 820 -y 500 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 340 -y 580 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 3 -x 1140 -y 110 -defaultsOSRD
preplace inst axi_timer_1 -pg 1 -lvl 3 -x 1140 -y 310 -defaultsOSRD
preplace inst axi_timer_2 -pg 1 -lvl 3 -x 1140 -y 650 -defaultsOSRD
preplace inst axi_timer_3 -pg 1 -lvl 3 -x 1140 -y 850 -defaultsOSRD
preplace netloc axi_timer_0_pwm0 1 3 1 NJ 120
preplace netloc axi_timer_1_pwm0 1 3 1 NJ 320
preplace netloc axi_timer_2_pwm0 1 3 1 NJ 660
preplace netloc axi_timer_3_pwm0 1 3 1 NJ 860
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 2 680 270 1010
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 40 270 670 260 990
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 50 470 630
preplace netloc axi_gpio_0_GPIO 1 3 1 NJ 480
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 N 460
preplace netloc ps8_0_axi_periph_M01_AXI 1 2 1 960 60n
preplace netloc ps8_0_axi_periph_M02_AXI 1 2 1 1000 260n
preplace netloc ps8_0_axi_periph_M03_AXI 1 2 1 970 520n
preplace netloc ps8_0_axi_periph_M04_AXI 1 2 1 960 540n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 330
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 N 350
levelinfo -pg 1 0 340 820 1140 1290
pagesize -pg 1 -db -bbox -sgen 0 0 1410 960
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/kr260-pwm-test.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/kr260-pwm-test.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
