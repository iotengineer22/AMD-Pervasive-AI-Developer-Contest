...
#
# amd_contest_design.tcl: Tcl script for re-creating project 'amd_contest_design'
#
# Generated by Vivado on Sat Jun 01 18:47:19 JST 2024
...
#
# 1. This project restoration tcl script (amd_contest_design.tcl) that was generated.
#
...
set _xil_proj_name_ "amd_contest_design"
...
set script_file "amd_contest_design.tcl"
...
set_property -name "platform.name" -value "amd_contest_design" -objects $obj
...
\
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins proc_sys_reset_3/ext_reset_in] [get_bd_pins proc_sys_reset_4/ext_reset_in] [get_bd_pins proc_sys_reset_5/ext_reset_in] [get_bd_pins rst_ps8_0_99M/ext_reset_in]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.551466",
   "Default View_TopLeft":"-370,4",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 350 -y 1170 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 350 -y 600 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -x 880 -y 100 -defaultsOSRD
preplace inst proc_sys_reset_1 -pg 1 -lvl 2 -x 880 -y 280 -defaultsOSRD
preplace inst proc_sys_reset_2 -pg 1 -lvl 2 -x 880 -y 460 -defaultsOSRD
preplace inst proc_sys_reset_3 -pg 1 -lvl 2 -x 880 -y 640 -defaultsOSRD
preplace inst proc_sys_reset_4 -pg 1 -lvl 2 -x 880 -y 820 -defaultsOSRD
preplace inst proc_sys_reset_5 -pg 1 -lvl 2 -x 880 -y 1000 -defaultsOSRD
preplace inst axi_intc_0 -pg 1 -lvl 3 -x 1170 -y 1230 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 880 -y 1200 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 350 -y 1360 -defaultsOSRD
preplace netloc axi_intc_0_irq 1 0 4 50 1460 NJ 1460 NJ 1460 1270
preplace netloc clk_wiz_0_clk_out1 1 1 1 640 60n
preplace netloc clk_wiz_0_clk_out2 1 1 1 690 240n
preplace netloc clk_wiz_0_clk_out3 1 1 1 700 420n
preplace netloc clk_wiz_0_clk_out4 1 1 1 N 600
preplace netloc clk_wiz_0_clk_out5 1 1 1 640 620n
preplace netloc clk_wiz_0_clk_out6 1 1 1 700 640n
preplace netloc clk_wiz_0_locked 1 1 1 710 140n
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 2 710 1330 1060J
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 60 1260 700 1320 1050J
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 40 720 680
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 N 1200
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 1 1 N 1140
levelinfo -pg 1 0 350 880 1170 1290
pagesize -pg 1 -db -bbox -sgen 0 0 1290 1470
"
}
  ...
  set_property PFM_NAME {xilinx:kr260_som:amd_contest_design:0.0} [get_files [current_bd_design].bd]
...
set_property PFM_NAME "xilinx:kr260_som:amd_contest_design:0.0" [get_files design_1.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files design_1.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/amd_contest_design.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
